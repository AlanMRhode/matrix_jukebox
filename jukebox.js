...
// this is an array called songs which has the link to mutiple mp3 matrix sound clips
...
// for the length of the array, we create multiple 
...
// play buttons will display at a red pill
        $('.play').click(function() {
        	console.log($(this));
...
// stop buttons will display as a blue pill
        $('.stop').click(function() {
            myMusic.pauseSong();
        });
